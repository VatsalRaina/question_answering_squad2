...
def main(args):
    ...
    tokenizer_en_to_fr = AutoTokenizer.from_pretrained("Helsinki-NLP/opus-mt-en-es")
    tokenizer_fr_to_en = AutoTokenizer.from_pretrained("Helsinki-NLP/opus-mt-es-en")

    model_en_to_fr = AutoModelForSeq2SeqLM.from_pretrained("Helsinki-NLP/opus-mt-en-es")
    model_fr_to_en = AutoModelForSeq2SeqLM.from_pretrained("Helsinki-NLP/opus-mt-es-en")
    ...
    with open(args.predictions_save_path + "augmented_squad2_sec1_spanish.json", 'w') as fp:
